...
public enum CoreHttpStatus {
    ...
    private static final CoreHttpStatus[] VALUES;
    ...
    CoreHttpStatus(int value, Series series, String reasonPhrase) {
        this.value = value;
        this.series = series;
     ...
     */
    public static CoreHttpStatus valueOf(int statusCode) {
        CoreHttpStatus status = resolve(statusCode);
        if (status == null) {
     ...
     */
    @Nullable
    public static CoreHttpStatus resolve(int statusCode) {
        // Use cached VALUES instead of values() to prevent array allocation.
        for (CoreHttpStatus status : VALUES) {
     ...
     * <p>Retrievable via {@link CoreHttpStatus#series()}.
     */
    public enum Series {
         ...
         * @return the {@code Series} enum constant for the supplied {@code HttpStatus}
         * @deprecated as of 5.3, in favor of invoking {@link CoreHttpStatus#series()} directly
         */
        @Deprecated
        public static Series valueOf(CoreHttpStatus status) {
